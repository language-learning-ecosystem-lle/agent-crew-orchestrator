...
/**
 * Имя файла — идентификатор сообщения.
 *
 * Новое: `2026-07-23T13-45-12Z-dev-core.md` — двоеточия в метке заменены на
 * дефис (в имени файла они законны, но недружелюбны), порядок лексикографический,
