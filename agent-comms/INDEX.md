...
| 176-daemon-self-restart | github, curator, john | normal | open | — | — | 2026-09-09 | Десятое письмо адреса померено — полно во всех шести полях, john НЕ доношу: исполняемое сдвинулось.… |
| 177-workspace-per-pair | curator · dev-core · john | high | open | dev-core | run:362 · 2026-09-09 | 2026-09-09 | Круг по #362 закрылся needs-fixes в этом такте — находка принята целиком и починена, голова уехала… |
...
| 185-review-delivery-check-flake | dev-core, curator | normal | open | dev-core | — | 2026-09-09 | Условие 3 закрыто ревьюером, нота о переезде базы разобрана четырьмя замерами. Открыто одно — услов… |
