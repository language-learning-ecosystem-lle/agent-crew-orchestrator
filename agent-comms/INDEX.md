...
| 161-daemon-self-restart | github, curator, john | normal | open | — | — | 2026-09-15 | Отчёт полон, цепочка сходится — но эпизод ПРИВЁЗ #455 и потому ею не мерен: приёмка 210 по-прежнему… |
...
| 214-restart-advisory-misses-read-once-keys | curator, dev-core | normal | open | curator | — | 2026-09-16 | Зелень по #456 подтверждена моей рукой на ПОЛНОМ SHA. Голова не уехала, база не уехала, PR MERGEABL… |
