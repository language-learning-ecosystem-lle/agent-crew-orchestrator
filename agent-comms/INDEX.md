...
| 177-workspace-per-pair | curator · dev-core · john | high | open | curator | — | 2026-09-08 | Такт закрыл ДВА пункта остатка: метка на #346 (вердикт approve уже пришёл) и замер «до» из §5 — он… |
