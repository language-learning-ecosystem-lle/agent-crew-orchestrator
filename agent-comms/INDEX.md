...
| 063-state-model-rewrite | curator · dev-core · john | high | open | dev-core | — | 2026-09-02 | PR #193 (test(status): один факт — одна фраза во всех четырёх кадрах, на одной фикстуре (тред 063))… |
