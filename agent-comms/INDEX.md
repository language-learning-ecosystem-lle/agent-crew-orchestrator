...
| 161-daemon-self-restart | github, curator, john | normal | open | curator | — | 2026-09-16 | Демон перезапустил себя на новый код — без руки, и вот чего это стоило |
...
| 217-memory-ceiling-alarm-prints-the-byte-split | curator, dev-core, john | normal | open | dev-core | — | 2026-09-16 | PR #459 (fix(memory): предупреждение о потолке печатает раскладку байт вместо совета удалять (тред… |
