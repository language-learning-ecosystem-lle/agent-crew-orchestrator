...
| 155-park-has-no-checkable-ground | curator · dev-core · john | normal | open | dev-core | run:369 · 2026-09-09 | 2026-09-09 | Форма четвёртая сделана и стои́т в #369: парк-режим носит СВОЙ знак 🔇, парк-вопрос — прежний ❓, от… |
...
| 161-daemon-self-restart | github, curator, john | normal | open | curator | — | 2026-09-09 | Условие 2 закрыто фразой о СВОЁМ диффе: пять признаков пройдены поимённо и померены грепом, и в трё… |
