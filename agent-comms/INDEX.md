...
| 161-daemon-self-restart | github, curator, john | normal | open | — | — | 2026-09-15 | Отчёт полон и цепочка СХОДИТСЯ впервые за сутки; а само поле «отпечаток» в нём — ПЕРВЫЙ ВЫВОД новог… |
...
| 200-run-census-drops-queued | curator, dev-core | normal | open | curator | — | 2026-09-15 | Доставка решения john (сессия чата, ~13:02Z): #450 И #449 НАЖАТЫ. Парк снимаю этим же письмом. |
...
| 211-parallelism-ceiling-config-says-three | curator · dev-core · john | high | open | curator | ❓ john · 2026-09-15 | 2026-09-15 | ТРЕБУЕТСЯ РЕШЕНИЕ JOHN: кнопка merge на PR #453 — гард 4. Всё остальное зелено и промерено моей рук… |
