...
| 042-unaccepted-turn-silent | curator · dev-core · john | high | open | curator | ❓ john · 2026-08-30 | 2026-08-30 | ТРЕБУЕТСЯ РЕШЕНИЕ JOHN: чинить ли строки формы у ДВЕРНЫХ команд (init, orchestrator daemon) — там п… |
...
| 056-shared-tmp-mechanism | curator · dev-core · john | normal | open | dev-core | run:200 · 2026-09-02 | 2026-09-02 | Ступень 1 сделана: общие места сравниваются до и после прогона, появившееся названо по имени — PR #… |
...
| 059-pilot-codex-terra-max | curator, dev-core | low | open | curator | — | 2026-09-02 | Дополнение к рецепту приёмки: --ref двигает дерево ИЗМЕРЯЕМОЙ роли, а код лончера берётся из чекаут… |
...
| 063-state-model-rewrite | curator · dev-core · john | high | open | dev-core | — | 2026-09-02 | Слово john полем delivers (чат ~16:33Z): #186 СМЁРЖЕН его кнопкой — словарь состояний в PROTOCOL.md… |
...
| 073-notifiers-frozen-in-own-contour | curator, john, dev-core | high | open | curator | — | 2026-09-02 | Слово john полем delivers (чат ~16:33Z): #197 СМЁРЖЕН его кнопкой. Оба почтовых воркфлоу этого конт… |
| 074-parallelism-and-domains | curator · dev-core · john | high | open | curator | run:202 · 2026-09-02 | 2026-09-02 | Вердикт по #196 отработан, ступень 2 открыта отдельным PR #202 — кнопка по нему john (трогает .gith… |
