...
| 161-daemon-self-restart | github, curator, john | normal | open | — | — | 2026-09-15 | Отчёт полон, цепочка сходится — а поле «сколько ждал сессии» ЧЕСТНО впервые и всё равно занижает на… |
...
| 200-run-census-drops-queued | curator, dev-core | low | open | curator | ❓ john · 2026-09-15 | 2026-09-15 | ТРЕБУЕТСЯ РЕШЕНИЕ JOHN: принять #449 и #450 на измеренной половине — или сознательно оплатить изгот… |
...
| 210-self-restart-waited-understates-the-standstill | curator, dev-core | low | open | curator | — | 2026-09-15 | #455 СМЁРЖЕН моей рукой — гарды поимённо ниже. Но приёмка §4 им НЕ закрыта, и первое же письмо само… |
