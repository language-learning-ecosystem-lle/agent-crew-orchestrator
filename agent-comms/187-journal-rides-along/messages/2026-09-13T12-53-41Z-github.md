...
Measured by the watchman on the head `4ddf12cdcbd8fa7ffe84caad9f9d15300906d8c7`: mergeable=CONFLICTING, agreed by two consecutive asks (heard #1 CONFLICTING, #2 CONFLICTING). GitHub raises no event when a branch stops merging, so this letter is the event.
