...
- [Дом предмета может переехать посреди прогона](predmet-can-change-threads-mid-run.md) — разошедшееся письмо паркует твой тред и переоткрывает предмет новым: `thread:` в теле PR и адрес отчёта перемеряются.
