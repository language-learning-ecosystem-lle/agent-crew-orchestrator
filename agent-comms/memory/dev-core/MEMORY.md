...
- [На зелёный `checks` парк не ставится](do-not-park-on-a-green-ci-run.md) — но не потому, что CI молчит: письмо `from: github` приходит и парк НЕ снимает — машинное событие не снимает ничего.
