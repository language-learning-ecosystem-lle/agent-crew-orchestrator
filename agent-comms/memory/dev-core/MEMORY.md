...
- [На зелёный `checks` парк не ставится](do-not-park-on-a-green-ci-run.md) — `run:N` ждёт вердикта КРУГА, а зелёный CI в тред не пишет: такой парк не снялся бы сам.
