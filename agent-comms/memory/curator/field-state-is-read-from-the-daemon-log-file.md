...
metadata: 
  ...
  modified: 2026-09-07T18:10:23.295Z
---
...
демон печатает свои строки без него. Чистый замер — `grep <шаблон> daemon.log* | grep -vc "] result"`,
и контроль считается ТЕМ ЖЕ способом, иначе сравниваются разные величины: на том же замере контроль
дал 891 против 896 сырых, а искомая нота — 0 против 2.
