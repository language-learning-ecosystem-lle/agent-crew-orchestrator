...
metadata: 
  ...
  modified: 2026-09-15T10:26:25.595Z
---
...
(чужой абзац не переписан, append-only цел). **Вторая мера врёт, когда удаления несёт САМ `main`**
(15.09, #440: 89 удалений в `c32b6ee → ca5474226` — при 139 в `c32b6ee → origin/main`): её показание
годится только вместе с контрольным `git diff --numstat <старая голова> origin/main`, а несущей
остаётся первая. Проверить это своей рукой дёшево и не читая диффа:
