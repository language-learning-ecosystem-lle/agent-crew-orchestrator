...
- [Ход под живым `checks` передаётся БЕЗ парка](no-park-beats-run-park-under-live-checks.md) — подъём ключуется на ТВОЁ письмо (43 с), а не на зелень: окупает его незакрытое действие своей руки
