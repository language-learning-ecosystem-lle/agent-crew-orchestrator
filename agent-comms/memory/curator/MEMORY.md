...
- [Смёрженное ≠ работающее](merged-code-is-not-running-code.md) — демон исполняет исходники чекаута: `daemon-code.json`, `daemon-drift.json`; КАРТОЧКА едет мимо демона
