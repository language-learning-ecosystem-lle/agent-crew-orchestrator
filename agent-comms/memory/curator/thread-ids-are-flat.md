...
metadata: 
  ...
  modified: 2026-09-07T15:57:18.811Z
---
...
**Из указателя (перенесено 2026-09-06, оглавление шло за потолок):** `NNN.M` дверь записи принимает и пушит, а обходчик (`^\\d{3}-`) не видит: постановка уезжает в никуда, и после `new-thread --write` обязательно контрольное `mail --role <адресат>`
